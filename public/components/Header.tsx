    ...
    <div className="bg-white">
      ...
      <div className="flex justify-end  px-1 md:px-20 py-6  ">
        <div className="flex gap-6  text-gray-700 text-center text-xs md:text-base md:font-bold">
          <div className="text-green-800 text-3xl border rounded-md p-0.5 cursor-pointer md:mr-[666px]">
            <IoSearchCircleOutline />
          </div>
          <Link href="#" className="hover:text-green-600  md:mt-0.5">
            درباره ما
          </Link>
          <Link onClick={toggleModal} href="#" className="hover:text-green-600 md:mt-0.5">
            تماس با ما
          </Link>
          <Link href="#" className="hover:text-green-600 md:mt-0.5">
            وبلاگ
          </Link>
          <Link href="#" className="text-green-600 hover:text-green-600 md:mt-0.5">
            صفحه اصلی
          </Link>
        </div>
        <div className="text-green-800 font-bold items-center text-xl text-center mx-8 ">
          روف پلاست
        </div>
      </div>
